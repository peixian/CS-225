...
void testReverse()
{
	...
	List<int> listTest;
	for (int i = 0; i<5; i++) {
		listTest.insertBack(i);
	}
	cout << "[reverseTest]: " << listTest << endl;
	listTest.reverse();
	cout << "[reverseTest final]: " << listTest <<endl;
...
void testReverseNth()
{
	...
	List<int> listNth;
	for (int i = 0; i<10; i++) {
		listNth.insertBack(i);
	}
	cout << "[reverseTest]: " << listNth << endl;
	listNth.reverseNth(3);
	cout << "[reverseTest final]: " << listNth <<endl;
